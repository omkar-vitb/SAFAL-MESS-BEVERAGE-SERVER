...
FEATURES : 1.Mess staff needs to input quantity of beverages they want to put in machine initially in litre.
           ...
           4.Each serving gives exactly 120 ml.
           5.The program checks if enough beverage is left before serving.
...
INSTRUCTIONS FOR TESTING: 1.In starting Mess staff must enter the quantity of milk,coffee and tea. If they dont want to put any particular beverage they can simply                              enter 0.
                ...
                5.Staff may also check quantity at any given time to get the idea whether they need to refill or not.
                6.And when serving time is over , finally Staff also have the option to switch off the machine.
